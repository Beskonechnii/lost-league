 ...
 * как карточка.
 *
 * Пять токенов и ни одного литерала: ширина страницы всегда называется словом, поэтому видно, к
 * какому из типов страница себя относит, и правится она в одном месте (UI-GUIDELINES §4).
 */
export const AUTH_MAX_W = "max-w-[420px]";

/**
 * Мера таблицы данных — ширина артборда Кита «Турнирная таблица» (доска 1120 − 2 × 48). Сетка
 * колонок таблицы фиксирована (64 · 1fr · 56 · 56 · 56 · 74 · 104 · 88), поэтому на широком экране
 * всё лишнее уходит в колонку «Команда»: между именем и числами оставалось около 600px пустоты.
 */
export const TABLE_MAX_W = "max-w-[64rem]";
