 ...
 * прочитать. Поэтому третьей ступени здесь не осталось вовсе: всё, что видно
 * глазом, живёт на ступень темнее (`--muted`). Сама вторая ступень затемнена
 * 04.09 до 4.52:1 — до того она давала 3.24:1 и эти же шапки колонок 11px/800
 * проваливали AA (DECISIONS.md).
 */
