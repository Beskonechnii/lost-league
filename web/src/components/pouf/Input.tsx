...
// Поле пароля вынесено в свой клиентский файл (у него состояние), но зовётся отсюда же.
...
export interface FormInputProps extends Omit<InputHTMLAttributes<HTMLInputElement>, 'className' | 'size'> {
  invalid?: boolean
  mono?: boolean
