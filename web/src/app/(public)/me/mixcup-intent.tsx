 ...
 * хватает для записи (анкета отправлена либо аккаунт уже одобрен), сервер тихо записывает и отдаёт
 * путь назад на турнир — здесь остаётся только уйти по нему. Не хватает — action возвращает null, эффект
