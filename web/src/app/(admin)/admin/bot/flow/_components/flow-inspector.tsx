      ...
      <ul className="mt-1 space-y-1.5">
        {ports.map((p) => (
          <li key={p.key} className="flex items-center gap-2">
            ...
            >
              {/* Подпись пустой цели: до Э6 незаполненный выход отдавал разговор старому
                  обработчику, с Э6 отдавать некому — это просто дыра, и валидатор её не пропустит. */}
              <option value="">— выход не заполнен —</option>
