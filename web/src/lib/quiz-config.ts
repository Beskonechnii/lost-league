...
export const QUIZ_SLOTS: Slot[] = [
  {
    key: "hello",
    label: "Приветствие",
    hint: "Первое сообщение на /start",
    text: "Заявка команды в лигу LOST. Отвечайте по одному сообщению; начать заново — /start.",
  },
  {
    key: "closed",
    label: "Приём закрыт",
    hint: "Ответ, когда ни один турнир не принимает заявки",
    text: "Сейчас приём заявок закрыт. Как откроется — возвращайтесь, команда /start.",
  },
  {
    key: "tournament",
    label: "Выбор турнира",
  ...
  { key: "confirm", label: "Перед отправкой", hint: "Строка под сводкой состава", text: "Всё верно?" },
  {
    ...
    text:
      ...
      "Поправить состав можно новой заявкой: /start.",
  },
];
