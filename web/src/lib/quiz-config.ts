...
export const QUIZ_SLOTS: Slot[] = [
  {
    ...
    text:
      "Бот лиги LOST. Здесь можно подать заявку команды, посмотреть свой состав, профиль и турниры.\n" +
  ...
  { key: "confirm", label: "Перед отправкой", hint: "Строка под сводкой состава", text: "Всё верно?" },
  {
    ...
    text:
      ...
      "Посмотреть, что с ней, — «Мой состав». Поправить состав — подайте заявку заново.",
  },
];
