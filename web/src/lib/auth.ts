...
const PROTECTED_PAGES = [
  ...
  // Консоль турниров индивидуального формата живёт под /admin — уже закрыта префиксом "/admin"
  // выше. /join/<slug> без этого префикса — публичная страница записи (ТЗ 34/37), закрывать её
  // было бы отменой её же смысла.
