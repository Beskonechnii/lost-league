...
const PROTECTED_PAGES = [
  ...
  // Mix Cup (ТЗ 33/34) операторский раздел переехал под /admin/mixcup — уже закрыт префиксом
  // "/admin" ниже. /mixcup/<slug> без этого префикса — публичная страница регистрации (ТЗ 34),
  // закрывать её было бы отменой её же смысла.
