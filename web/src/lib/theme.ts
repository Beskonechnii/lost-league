...
export const FIELDS: ThemeField[] = [
  ...
  { key: "inkMuted", label: "Текст приглушённый", hint: "Подписи 11px сидят на нём — светлее #69655D нельзя, провалит AA", group: "Текст", cssVar: "--lost-ink-muted" },
  { key: "inkSubtle", label: "Текст тусклый", hint: "Декоративная ступень: точка, штрих, разделитель. Текст на неё не сажаем", group: "Текст", cssVar: "--lost-ink-subtle" },
